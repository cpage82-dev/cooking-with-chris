...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt.token_blacklist',  # Required for logout functionality
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Cooking with Chris API',
    'DESCRIPTION': 'API for managing and sharing recipes',
    'VERSION': '1.0.0',
